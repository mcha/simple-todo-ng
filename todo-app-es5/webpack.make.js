...
module.exports = function makeWebpackConfig (options) {
  ...
  config.module = {
    ...
    loaders: [{
      // JS LOADER
      // Reference: https://github.com/babel/babel-loade// Compiles ES6 and ES7 into ES5 code
      test: /\.js$/,
  ...
  var scssLoader = {
    test: /\.scss$/,
    loader: 'style!style!css?sourceMap!ruby-sass'
  };
